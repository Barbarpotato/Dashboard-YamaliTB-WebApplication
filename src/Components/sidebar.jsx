            ...
            <Sidebar width={window.screen.width < 500 ? '150px' : '250px'} backgroundColor='rgb(39, 41, 61, 1)' style={{ 'height': '100vh' }}>
                <Menu >
                    ...
                    <SubMenu icon={<FiFile></FiFile>} className='submenu text-left' label="Artikel">
                        ...
                        <MenuItem onClick={() => setInfo(!info)} icon={<FiTrash></FiTrash>} routerLink={<Link to='/HapusArtikel'></Link>} className='menu text-left'>Hapus Data</MenuItem>
                    </SubMenu>
                    <SubMenu icon={<FiBookOpen></FiBookOpen>} className='submenu text-left' label='Berita'>
                        ...
                        <MenuItem onClick={() => setInfo(!info)} icon={<FiTrash></FiTrash>} routerLink={<Link to='/HapusBerita'></Link>} className='menu text-left'>Hapus Data</MenuItem>
                    </SubMenu>
                    ...
                    <MenuItem icon={<FaExclamation></FaExclamation>} routerLink={<Link to=""></Link>} className='menu text-left'>Informasi Dashboard</MenuItem>
                </Menu>
            </Sidebar >
